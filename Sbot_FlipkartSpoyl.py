'''DATA SCRAPPING BOT [FLIPKART SPOYL] FOR RAWCULT TREND-ANALYSIS
~ SHIVAM RAJPUT '''
...
MAX_PRODUCT_FROM_EACH_CATEGORY = NO_OF_PRODUCTS_TO_SCRAPE['FlipkartSpoyl']
URL_DICT = TO_SCRAPE_URL_DICT['FlipkartSpoyl']
...
for SUB_CATEGORY in URL_DICT.keys():
    ...
    for sort_type in sort_dict.keys():
        ...
        print(f'[FLIPKART SPOYL] >> {SUB_CATEGORY} >> {sort_type}\n')
...
with open(f'prodData_Flipkartspoyl.json', 'w', encoding="utf-8") as fl:
